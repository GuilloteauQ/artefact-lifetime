...
\item \emph{Replicable}: the measurementss can be obtained again by people who do not belong to the original work without the original artifact.
\end{enumerate}
...
Badges have be shown to be an effective strategy to incentisize authors to make the data of their works available \cite{kidwell2016badges, rowhani2017incentives}.
...
Requiering artifacts to have a Software Bill of Material (SBOM) \cite{sbom, xia2023empirical} would greatly improve the tracability of the artifacts (\eg\ for Nix \cite{genealogos}).
More generaly, having a standardized file describing the metadata of the artifact. \todo{}
