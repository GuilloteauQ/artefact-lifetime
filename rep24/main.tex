...
\newtcbtheorem[]{recommendation}{Recommendation}{colback=unibasmintlight,colframe=unibasmint,fonttitle=\bfseries}{th}
...
\begin{abstract}
  ...
  By reviewing the methods and tools used to create and share artifacts in a technical, in-depth, and article content-agnostic manner, we found that the state of practice does not address reproducibility in terms of artifact \emph{longevity} and expose seven observations that support this finding.
...
\begin{table*}
  ...
  \toprule
%\multicolumn{1}{c}{\textbf{Conferences} } & \multicolumn{3}{c}{\textbf{Papers}} & \multicolumn{2}{c}{\textbf{Artifact URL}} & \multicolumn{3}{c}{\textbf{Artifact Badges}} \\
%\cmidrule(l{3pt}r{3pt}){2-4} \cmidrule(l{3pt}r{3pt}){5-6} \cmidrule(l{3pt}r{3pt}){7-9}
%{in 2023} & Accepted & Found PDF & Artifact Description & Specified & Dead \fmc{Available} & Available & Functional & Reproduced\\
...
We can see that the most penalizing criterion is the software environment, since most articles received a score of 0 because they do not describe their software environment accurately enough. % to be stable over time.
