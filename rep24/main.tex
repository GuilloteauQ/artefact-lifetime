...
Table\ \ref{tab:longevity} proposes a \textbf{first iteration} of a grading framework to evaluate the \emph{longevity} of an artifact base on three criterias: sharing of the source code, experimental setup used, and software environment.
