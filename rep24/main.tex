...
\begin{abstract}
  ...
  We found that the state-of-the-practice does not address reproducibility in terms of artifact \emph{longevity} and we expose 7 takeways that support this finding.
  To address this issue, we propose a new badge based on source code, experimental setup, and software environment criterias, which will allow to reward artifacts that will withstand the test of time.% and support reproducibility in the long term.  
...
These defintions themselves rely on the International vocabulary of Metrology\ \cite{defs_vim}, and are composed of three levels summarized here:
...
This work analyzes the \emph{longevity} of existing \ad s from the surveyed articles and exposes 7 takeaways messages summarizing our findings.
...
Table \ref{tab:table:papers_confs} summarizes our evaluations, including the number of articles for each conference and how many of them have an \ad.
